...
const readTreeBtn = { buttonid: 'readTree', text: 'Read Tree' };
...
const TreeCtrl = (props) => {
  ...
  const readTreeHandler = () => {
    props.apiReadTree();
  };
  return (
    <div id="TreeCtrl" style={TreeCtrlSty}>
      <JButton btn={readTreeBtn} parentClickHandler={readTreeHandler} />
      <JTreeView data={props.treeState.treeData} options={options} iconClick={iconHandler} titleClick={clickHandler} />
    </div>
  );
};
